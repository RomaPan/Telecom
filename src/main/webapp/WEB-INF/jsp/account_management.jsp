...
<body>
		...
		<div id="localization-button">
			<form action="controller" method="post">
				<input type="hidden" name="command" value="localize" /> <input
					type="hidden" name="sitelocation" value="account-management" /> <input
	...
	<div class="spacer"> </div>
		<div class="system-message">
			<p>
				<span class="red"> 
					<c:out value="${FindAccountByIDMessage}" />
					<c:out value="${BlockAccountMessage }" />
					<c:out value="${UnblockAccountMessage }" />
					<c:out value="${FindAccountByPhoneNumberMessage }" />				   
				</span>
			</p>
		</div>
	<div class="spacer"> </div>
	...
	<section>
		<div class="div-account-search" id="accountManagement">
			<p>${enter_phone_number}</p>
			<form action="controller" method="post">
				<input type="hidden" name="command" value="find-account-by-phone-number" /> 
		...
		<table id="admin-table-account">
			...
			<tbody>
				<tr>
					...
					<td><c:out value="${sessionScope.account.phoneNumberConnectedAt}" /></td>
