...
<fmt:message bundle="${loc }" key="local.change.phone.number.success" var="change_phone_number_success" />
<fmt:message bundle="${loc }" key="local.change.phone.number.failed" var="change_phone_number_failed" />
	...
	<div class="account-main-div">
		...
		<div id="your-account">
			...
			<h3>
				...
				<c:if test="${sessionScope.ChangePhoneNumberSuccess != null}">
				<c:out value="${change_phone_number_success}"/></c:if>
				
				<c:if test="${sessionScope.ChangePhoneNumberFailed != null}">
				<c:out value="${change_phone_number_failed}"/></c:if>
